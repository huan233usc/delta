...
public class ChecksumReader {
    ...
    public static Optional<VersionStats> getVersionStats(
        ...
        // last 100 versions.
        String crcFilePath = checksumFile(logPath, readVersion);
    ...
    private static Optional<VersionStats> readChecksumFile(Engine engine, String filePath) {
        try (CloseableIterator<ColumnarBatch> iter = engine.getJsonHandler()
                .readJsonFiles(
                        singletonCloseableIterator(FileStatus.of(filePath)),
