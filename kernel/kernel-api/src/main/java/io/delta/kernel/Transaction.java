...
public interface Transaction {
  ...
  List<TransactionStatCollector> getStatCollectors();
  ...
  static CloseableIterator<Row> generateAppendActions(
    ...
    List<TransactionStatCollector> statCollectors = new ArrayList<>();
    return generateAppendActions(
        engine, transactionState, fileStatusIter, dataWriteContext, statCollectors);
  }
  ...
  static CloseableIterator<Row> generateAppendActions(
      ...
      CloseableIterator<DataFileStatus> fileStatusIter,
      DataWriteContext dataWriteContext,
      List<TransactionStatCollector> statCollectors) {
    checkArgument(
        ...
        dataFileStatus -> {
          ...
          AddFile addFileRow =
              AddFile.convertDataFileStatus(
                  ...
                  true /* dataChange */);
          for (TransactionStatCollector transactionStatCollector : statCollectors) {
            transactionStatCollector.recordAddedFile(addFileRow);
          }
