...
public class SnapshotMetrics {
  ...
  public final Timer loadDomainMetadataActionsTimer = new Timer();
  ...
  public SnapshotMetricsResult captureSnapshotMetricsResult() {
    return new SnapshotMetricsResult() {
      ...
      final long loadDomainMetadataActionsDurationResult =
          loadDomainMetadataActionsTimer.totalDurationNs();
      ...
      @Override
      public long getLoadDomainMetadataActionsDurationNs() {
        return loadDomainMetadataActionsDurationResult;
      }
    };
  }
  ...
  public String toString() {
    return String.format(
        "SnapshotMetrics(timestampToVersionResolutionTimer=%s, "
            ...
            + "loadDomainMetadataActionsTimer=%s)",
        timestampToVersionResolutionTimer,
        loadInitialDeltaActionsTimer,
        loadDomainMetadataActionsTimer);
  }
}
