...
/**
 * Functional e2e test suite for verifying CRC are correct.
 */
// TODO: extend test case to check more information in CRC and
// deprecate ChecksumSimpleComparisonSuite
