 ...
 * Enhanced to support lifecycle management as specified in the design document.
 */
public abstract class AbstractDeltaTableManager implements DeltaTableManager {
     ...
     * Subclasses must call initialize() after construction.
     */
     ...
     * This will be deprecated in favor of no-arg constructor + initialize().
     * 
    ...
    /**
     * Create engine from properties. To be implemented by subclasses.
     * This is called during initialization to set up the Delta Kernel engine.
     * 
     ...
     * Called when the manager is being closed.
     */
    ...
    protected final void checkInitialized() {
        if (!initialized.get()) {
            throw new IllegalStateException("DeltaTableManager is not initialized. Call initialize() first.");
        }
    }
