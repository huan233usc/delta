...
/**
 * Unified exception class for DeltaTableManager operations. Provides consistent error handling
 * across all catalog implementations.
 */
public class DeltaTableManagerException extends RuntimeException {
  ...
  public DeltaTableManagerException(
      ErrorType errorType, String catalogType, String message, Throwable cause) {
  ...
  private static String formatMessage(ErrorType errorType, String catalogType, String message) {
    return String.format(
        "[%s] %s: %s", catalogType != null ? catalogType : "Unknown", errorType.name(), message);
  }
  ...
  public static DeltaTableManagerException versionNotFound(String catalogType, long version) {
    return new DeltaTableManagerException(
        ErrorType.VERSION_NOT_FOUND, catalogType, "Version " + version + " not found");
  }
  ...
  public static DeltaTableManagerException initializationError(
      String catalogType, Throwable cause) {
    return new DeltaTableManagerException(ErrorType.INITIALIZATION_ERROR, catalogType, cause);
  }

  public static DeltaTableManagerException invalidConfiguration(
      String catalogType, String message) {
  ...
  public static DeltaTableManagerException tableNotFound(String catalogType, String tablePath) {
    return new DeltaTableManagerException(
        ErrorType.TABLE_NOT_FOUND, catalogType, "Table not found at path: " + tablePath);
  }

  public static DeltaTableManagerException unsupportedOperation(
      String catalogType, String operation) {
    return new DeltaTableManagerException(
        ErrorType.UNSUPPORTED_OPERATION, catalogType, "Operation not supported: " + operation);
  }
}
