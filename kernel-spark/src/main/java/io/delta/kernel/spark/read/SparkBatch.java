...
public class SparkBatch implements Batch {
  ...
  public PartitionReaderFactory createReaderFactory() {
    ...
    // This is needed for proper handling of:
    ...
    DeltaParquetFileFormatV2 fileFormat =
        new DeltaParquetFileFormatV2(
            ((io.delta.kernel.internal.SnapshotImpl) initialSnapshot).getProtocol(),
            ((io.delta.kernel.internal.SnapshotImpl) initialSnapshot).getMetadata(),
            tablePath,
