 ...
 * 
 * Note: These tests use mock CatalogTable objects and may have limitations
 * due to Spark context requirements in real environments.
 */
public class DeltaTableManagerFactoryTest {
    ...
    public void testPathBasedTableManagerCreation() {
        ...
        // This will throw exceptions due to missing Spark context, but we can test the type detection logic
    ...
    public void testUnityCatalogTableDetection() {
        ...
        // Note: This will fail in test due to missing Spark context, but we can verify the detection logic
        try {
    ...
    public void testCustomImplementationLoading() {
        ...
        properties.put(DeltaTableManagerFactory.DELTA_TABLE_MANAGER_IMPL, 
    ...
    public void testInvalidImplementationClass() {
        java.util.Map<String, String> properties = new java.util.HashMap<>();
        properties.put(DeltaTableManagerFactory.DELTA_TABLE_MANAGER_IMPL, 
                      "com.example.NonExistentTableManager");
    ...
    /**
     * Helper method to create mock CatalogTable objects for testing.
     * Note: In real tests, you would use Spark's test utilities.
     */
    private CatalogTable createMockCatalogTable(String tablePath, java.util.Map<String, String> properties) {
